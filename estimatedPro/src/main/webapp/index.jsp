...
<body>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="d-flex flex-wrap mt-3">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-start">컴퓨터개론&nbsp;&nbsp;<small>설유준</small></div>
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋은 강의에요.&nbsp;<small>(1학기)</small>
				</h5>
				<p class="card-text">학점이 잘나온다.</p>
				<div class="row">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="registerModalLabel">평가등록</h5>
